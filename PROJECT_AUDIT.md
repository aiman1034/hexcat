...
- Next: **Fortinet** (87 — 5 DAC/breakout reconcile fixes first: ground connectors so physical_formfaktor resolves, then back-fill) → Arista (347, 42 reconcile fixes first), then 11 fresh brands, then switches (Rule-7 schema STOP).
