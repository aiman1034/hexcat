...
- Next: **await operator's independent audit** of the Cisco/Meraki ZIPs. On OK → re-verify MikroTik first (smallest), then HPE, Fortinet, Arista, updating this file after each.
